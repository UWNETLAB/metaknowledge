...
returns a list of all the citations in the record, the citations are the [metaknowledge.Citation]({{ site.baseurl }}{% post_url /docs/2015-10-10-Citation %}#Citation) class.
