...
class TestRecordCollection(unittest.TestCase):
    ...
    def test_coCite(self):
        ...
        self.assertEqual(len(Gdefault.nodes()), 516)
        self.assertEqual(len(Gdefault.edges()), 14252)
    ...
    def test_Cite(self):
        ...
        self.assertTrue('info' in Gdefault.nodes(data = True)[0][1])
        self.assertFalse('weight' in Gunwei.edges(data = True)[0][2])
        self.assertEqual(len(Gdefault.nodes()), 533)
        self.assertEqual(len(Ganon.nodes()), 533)
