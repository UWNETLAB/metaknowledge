...
<ol class="post-list">
<li><article><a href="#WOSCitation"><b>WOSCitation</b><span class="excerpt">A Citation that supports the WOS journal abbreviations</span></a></article></li>
<li><article><a href="#WOSRecord"><b>WOSRecord</b><span class="excerpt">The object for containing and processing WOS entries</span></a></article></li>
...
<li><article><a href="#GrantCollection"><b>GrantCollection</b><span class="excerpt">A Collection of Grants, this is what does most of the stuff on Grants</span></a></article></li>
<li><article><a href="#Grant"><b>Grant</b><span class="excerpt">The base for all the other Grants</span></a></article></li>
<li><article><a href="#DefaultGrant"><b>DefaultGrant</b><span class="excerpt">The Grant used if a file was not identifiable</span></a></article></li>
<li><article><a href="#CIHRGrant"><b>CIHRGrant</b><span class="excerpt">The container for CIHR grant entries</span></a></article></li>
<li><article><a href="#MedlineGrant"><b>MedlineGrant</b><span class="excerpt">The container for grants derived from Medline Records entries</span></a></article></li>
<li><article><a href="#NSERCGrant"><b>NSERCGrant</b><span class="excerpt">The container for NSERC grant entries</span></a></article></li>
<li><article><a href="#MedlineRecord"><b>MedlineRecord</b><span class="excerpt">The object for containing and processing Medline entries</span></a></article></li>
<li><article><a href="#Collection"><b>Collection</b><span class="excerpt">The base of all other Collections, basically a set</span></a></article></li>
<li><article><a href="#CollectionWithIDs"><b>CollectionWithIDs</b><span class="excerpt">A Collection that only holds <i>metaknowledge</i> objects</span></a></article></li>
<li><article><a href="#ExtendedRecord"><b>ExtendedRecord</b><span class="excerpt">A Record the processes its contents before returning them</span></a></article></li>
<li><article><a href="#Record"><b>Record</b><span class="excerpt">The base of all the other Records, basically a dict</span></a></article></li>
<li><article><a href="#ProQuestRecord"><b>ProQuestRecord</b><span class="excerpt">The object for containing and processing ProQuest entries</span></a></article></li>
<li><article><a href="#RecordCollection"><b>RecordCollection</b><span class="excerpt">A Collection of Records, this is what does most of the stuff on Records</span></a></article></li>
</ol>
...
<li><article><a href="#pop"><small>Grant</small>.<b>pop</b>(<i>key, default=<object object at 0x1048a1050></i>)</a></article></li>
...
<li><article><a href="#proQuestRecordParser"><small>proquest</small>.<b>proQuestRecordParser</b>(<i>record, recNum</i>)</a></article></li>
</ol>
...
<ol class="post-list">
<li><article><b>mkException</b></article></li>
<li><article><b>RCValueError</b></article></li>
<li><article><b>BadInputFile</b></article></li>
<li><article><b>BadRecord</b></article></li>
<li><article><b>BadPubmedRecord</b></article></li>
<li><article><b>BadPubmedFile</b></article></li>
<li><article><b>BadProQuestRecord</b></article></li>
<li><article><b>BadProQuestFile</b></article></li>
<li><article><b>RecordsNotCompatible</b></article></li>
<li><article><b>cacheError</b></article></li>
<li><article><b>CollectionTypeError</b></article></li>
<li><article><b>BadWOSRecord</b></article></li>
<li><article><b>BadWOSFile</b></article></li>
<li><article><b>BadCitation</b></article></li>
<li><article><b>BadGrant</b></article></li>
<li><article><b>RCTypeError</b></article></li>
<li><article><b>GrantCollectionException</b></article></li>
<li><article><b>UnknownFile</b></article></li>
</ol>
...
<a name="WOSCitation"></a><small></small>**[<ins>WOSCitation</ins>](#WOSCitation)**(_Citation_):
...
<a name="isAnonymous"></a><small>WOSCitation.</small>**[<ins>isAnonymous</ins>]({{ site.baseurl }}{{ page.url }}#isAnonymous)**():
...
<a name="ID"></a><small>WOSCitation.</small>**[<ins>ID</ins>]({{ site.baseurl }}{{ page.url }}#ID)**():
...
<a name="allButDOI"></a><small>WOSCitation.</small>**[<ins>allButDOI</ins>]({{ site.baseurl }}{{ page.url }}#allButDOI)**():
...
<a name="Extra"></a><small>WOSCitation.</small>**[<ins>Extra</ins>]({{ site.baseurl }}{{ page.url }}#Extra)**():
...
<li><article><a href="#keys"><b>keys</b>()</a></article></li>
</ol>
<hr style="padding: 0;border: none;border-width: 3px;height: 20px;color: #333;text-align: center;border-top-style: solid;border-bottom-style: solid;">
...
<a name="copy"></a><small>WOSRecord.</small>**[<ins>copy</ins>]({{ site.baseurl }}{{ page.url }}#copy)**():

# Needs to be written

<hr style="padding: 0;border: none;border-width: 3px;height: 20px;color: #333;text-align: center;border-top-style: solid;border-bottom-style: solid;">

<a name="get"></a><small>WOSRecord.</small>**[<ins>get</ins>]({{ site.baseurl }}{{ page.url }}#get)**(_tag, default=None, raw=False_):
...
<a name="values"></a><small>WOSRecord.</small>**[<ins>values</ins>]({{ site.baseurl }}{{ page.url }}#values)**(_raw=False_):
...
<a name="items"></a><small>WOSRecord.</small>**[<ins>items</ins>]({{ site.baseurl }}{{ page.url }}#items)**(_raw=False_):
...
<a name="subDict"></a><small>WOSRecord.</small>**[<ins>subDict</ins>]({{ site.baseurl }}{{ page.url }}#subDict)**(_tags, raw=True_):
...
<a name="createCitation"></a><small>WOSRecord.</small>**[<ins>createCitation</ins>]({{ site.baseurl }}{{ page.url }}#createCitation)**(_multiCite=False_):
...
<a name="keys"></a><small>WOSRecord.</small>**[<ins>keys</ins>]({{ site.baseurl }}{{ page.url }}#keys)**():
...
<li><article><a href="#isdisjoint"><b>isdisjoint</b>(<i>other</i>)</a></article></li>
</ol>
<hr style="padding: 0;border: none;border-width: 3px;height: 20px;color: #333;text-align: center;border-top-style: solid;border-bottom-style: solid;">

<a name="copy"></a><small>GrantCollection.</small>**[<ins>copy</ins>]({{ site.baseurl }}{{ page.url }}#copy)**():

# Needs to be written

<hr style="padding: 0;border: none;border-width: 3px;height: 20px;color: #333;text-align: center;border-top-style: solid;border-bottom-style: solid;">

<a name="peak"></a><small>GrantCollection.</small>**[<ins>peak</ins>]({{ site.baseurl }}{{ page.url }}#peak)**():

# Needs to be written

<hr style="padding: 0;border: none;border-width: 3px;height: 20px;color: #333;text-align: center;border-top-style: solid;border-bottom-style: solid;">

<a name="chunk"></a><small>GrantCollection.</small>**[<ins>chunk</ins>]({{ site.baseurl }}{{ page.url }}#chunk)**(_maxSize_):

# Needs to be written

<hr style="padding: 0;border: none;border-width: 3px;height: 20px;color: #333;text-align: center;border-top-style: solid;border-bottom-style: solid;">

<a name="split"></a><small>GrantCollection.</small>**[<ins>split</ins>]({{ site.baseurl }}{{ page.url }}#split)**(_maxSize_):
...
<a name="containsID"></a><small>GrantCollection.</small>**[<ins>containsID</ins>]({{ site.baseurl }}{{ page.url }}#containsID)**(_idVal_):

# Needs to be written

<hr style="padding: 0;border: none;border-width: 3px;height: 20px;color: #333;text-align: center;border-top-style: solid;border-bottom-style: solid;">

<a name="discardID"></a><small>GrantCollection.</small>**[<ins>discardID</ins>]({{ site.baseurl }}{{ page.url }}#discardID)**(_idVal_):

# Needs to be written

<hr style="padding: 0;border: none;border-width: 3px;height: 20px;color: #333;text-align: center;border-top-style: solid;border-bottom-style: solid;">

<a name="removeID"></a><small>GrantCollection.</small>**[<ins>removeID</ins>]({{ site.baseurl }}{{ page.url }}#removeID)**(_idVal_):

# Needs to be written

<hr style="padding: 0;border: none;border-width: 3px;height: 20px;color: #333;text-align: center;border-top-style: solid;border-bottom-style: solid;">

<a name="getID"></a><small>GrantCollection.</small>**[<ins>getID</ins>]({{ site.baseurl }}{{ page.url }}#getID)**(_idVal_):

# Needs to be written

<hr style="padding: 0;border: none;border-width: 3px;height: 20px;color: #333;text-align: center;border-top-style: solid;border-bottom-style: solid;">

<a name="badEntries"></a><small>GrantCollection.</small>**[<ins>badEntries</ins>]({{ site.baseurl }}{{ page.url }}#badEntries)**():

# Needs to be written

<hr style="padding: 0;border: none;border-width: 3px;height: 20px;color: #333;text-align: center;border-top-style: solid;border-bottom-style: solid;">

<a name="dropBadEntries"></a><small>GrantCollection.</small>**[<ins>dropBadEntries</ins>]({{ site.baseurl }}{{ page.url }}#dropBadEntries)**():

# Needs to be written

<hr style="padding: 0;border: none;border-width: 3px;height: 20px;color: #333;text-align: center;border-top-style: solid;border-bottom-style: solid;">

<a name="tags"></a><small>GrantCollection.</small>**[<ins>tags</ins>]({{ site.baseurl }}{{ page.url }}#tags)**():

# Needs to be written

<hr style="padding: 0;border: none;border-width: 3px;height: 20px;color: #333;text-align: center;border-top-style: solid;border-bottom-style: solid;">

<a name="oneModeNetwork"></a><small>GrantCollection.</small>**[<ins>oneModeNetwork</ins>]({{ site.baseurl }}{{ page.url }}#oneModeNetwork)**(_mode, nodeCount=True, edgeWeight=True, stemmer=None, edgeAttribute=None, nodeAttribute=None_):
...
<a name="twoModeNetwork"></a><small>GrantCollection.</small>**[<ins>twoModeNetwork</ins>]({{ site.baseurl }}{{ page.url }}#twoModeNetwork)**(_tag1, tag2, directed=False, recordType=True, nodeCount=True, edgeWeight=True, stemmerTag1=None, stemmerTag2=None, edgeAttribute=None_):
...
<a name="nModeNetwork"></a><small>GrantCollection.</small>**[<ins>nModeNetwork</ins>]({{ site.baseurl }}{{ page.url }}#nModeNetwork)**(_tags, recordType=True, nodeCount=True, edgeWeight=True, stemmer=None, edgeAttribute=None_):
...
<a name="add"></a><small>GrantCollection.</small>**[<ins>add</ins>]({{ site.baseurl }}{{ page.url }}#add)**(_elem_):
...
<a name="discard"></a><small>GrantCollection.</small>**[<ins>discard</ins>]({{ site.baseurl }}{{ page.url }}#discard)**(_elem_):
...
<a name="remove"></a><small>GrantCollection.</small>**[<ins>remove</ins>]({{ site.baseurl }}{{ page.url }}#remove)**(_elem_):
...
<a name="clear"></a><small>GrantCollection.</small>**[<ins>clear</ins>]({{ site.baseurl }}{{ page.url }}#clear)**():
...
<a name="pop"></a><small>GrantCollection.</small>**[<ins>pop</ins>]({{ site.baseurl }}{{ page.url }}#pop)**():
...
<a name="isdisjoint"></a><small>GrantCollection.</small>**[<ins>isdisjoint</ins>]({{ site.baseurl }}{{ page.url }}#isdisjoint)**(_other_):
...
<li><article><a href="#__getitem__"><b>__getitem__</b>(<i>key</i>)</a></article></li>
...
<li><article><a href="#get"><b>get</b>(<i>key, default=None</i>)</a></article></li>
<li><article><a href="#keys"><b>keys</b>()</a></article></li>
<li><article><a href="#items"><b>items</b>()</a></article></li>
<li><article><a href="#values"><b>values</b>()</a></article></li>
<li><article><a href="#pop"><b>pop</b>(<i>key, default=<object object at 0x1048a1050></i>)</a></article></li>
...
<a name="copy"></a><small>Grant.</small>**[<ins>copy</ins>]({{ site.baseurl }}{{ page.url }}#copy)**():

# Needs to be written

<hr style="padding: 0;border: none;border-width: 3px;height: 20px;color: #333;text-align: center;border-top-style: solid;border-bottom-style: solid;">

<a name="__hash__"></a><small>Grant.</small>**[<ins>__hash__</ins>]({{ site.baseurl }}{{ page.url }}#__hash__)**():
...
<a name="__getitem__"></a><small>Grant.</small>**[<ins>__getitem__</ins>]({{ site.baseurl }}{{ page.url }}#__getitem__)**(_key_):
...
<a name="__eq__"></a><small>Grant.</small>**[<ins>__eq__</ins>]({{ site.baseurl }}{{ page.url }}#__eq__)**(_other_):
...
<a name="__str__"></a><small>Grant.</small>**[<ins>__str__</ins>]({{ site.baseurl }}{{ page.url }}#__str__)**():
...
<a name="__repr__"></a><small>Grant.</small>**[<ins>__repr__</ins>]({{ site.baseurl }}{{ page.url }}#__repr__)**():
...
<a name="get"></a><small>Grant.</small>**[<ins>get</ins>]({{ site.baseurl }}{{ page.url }}#get)**(_key, default=None_):
...
<a name="keys"></a><small>Grant.</small>**[<ins>keys</ins>]({{ site.baseurl }}{{ page.url }}#keys)**():
...
<a name="items"></a><small>Grant.</small>**[<ins>items</ins>]({{ site.baseurl }}{{ page.url }}#items)**():
...
<a name="values"></a><small>Grant.</small>**[<ins>values</ins>]({{ site.baseurl }}{{ page.url }}#values)**():
...
<a name="pop"></a><small>Grant.</small>**[<ins>pop</ins>]({{ site.baseurl }}{{ page.url }}#pop)**(_key, default=<object object at 0x1048a1050>_):
...
<a name="update"></a><small>DefaultGrant.</small>**[<ins>update</ins>]({{ site.baseurl }}{{ page.url }}#update)**(_other_):
...
<a name="copy"></a><small>DefaultGrant.</small>**[<ins>copy</ins>]({{ site.baseurl }}{{ page.url }}#copy)**():

# Needs to be written

<hr style="padding: 0;border: none;border-width: 3px;height: 20px;color: #333;text-align: center;border-top-style: solid;border-bottom-style: solid;">

<a name="__hash__"></a><small>DefaultGrant.</small>**[<ins>__hash__</ins>]({{ site.baseurl }}{{ page.url }}#__hash__)**():
...
<a name="__getitem__"></a><small>DefaultGrant.</small>**[<ins>__getitem__</ins>]({{ site.baseurl }}{{ page.url }}#__getitem__)**(_key_):
...
<a name="__eq__"></a><small>DefaultGrant.</small>**[<ins>__eq__</ins>]({{ site.baseurl }}{{ page.url }}#__eq__)**(_other_):
...
<a name="__str__"></a><small>DefaultGrant.</small>**[<ins>__str__</ins>]({{ site.baseurl }}{{ page.url }}#__str__)**():
...
<a name="__repr__"></a><small>DefaultGrant.</small>**[<ins>__repr__</ins>]({{ site.baseurl }}{{ page.url }}#__repr__)**():
...
<a name="get"></a><small>DefaultGrant.</small>**[<ins>get</ins>]({{ site.baseurl }}{{ page.url }}#get)**(_key, default=None_):
...
<a name="keys"></a><small>DefaultGrant.</small>**[<ins>keys</ins>]({{ site.baseurl }}{{ page.url }}#keys)**():
...
<a name="items"></a><small>DefaultGrant.</small>**[<ins>items</ins>]({{ site.baseurl }}{{ page.url }}#items)**():
...
<a name="values"></a><small>DefaultGrant.</small>**[<ins>values</ins>]({{ site.baseurl }}{{ page.url }}#values)**():
...
<a name="pop"></a><small>DefaultGrant.</small>**[<ins>pop</ins>]({{ site.baseurl }}{{ page.url }}#pop)**(_key, default=<object object at 0x1048a1050>_):
...
<a name="popitem"></a><small>DefaultGrant.</small>**[<ins>popitem</ins>]({{ site.baseurl }}{{ page.url }}#popitem)**():
...
<a name="clear"></a><small>DefaultGrant.</small>**[<ins>clear</ins>]({{ site.baseurl }}{{ page.url }}#clear)**():
...
<a name="setdefault"></a><small>DefaultGrant.</small>**[<ins>setdefault</ins>]({{ site.baseurl }}{{ page.url }}#setdefault)**(_key, default=None_):
...
<a name="update"></a><small>CIHRGrant.</small>**[<ins>update</ins>]({{ site.baseurl }}{{ page.url }}#update)**(_other_):
...
<a name="copy"></a><small>CIHRGrant.</small>**[<ins>copy</ins>]({{ site.baseurl }}{{ page.url }}#copy)**():

# Needs to be written

<hr style="padding: 0;border: none;border-width: 3px;height: 20px;color: #333;text-align: center;border-top-style: solid;border-bottom-style: solid;">

<a name="__hash__"></a><small>CIHRGrant.</small>**[<ins>__hash__</ins>]({{ site.baseurl }}{{ page.url }}#__hash__)**():
...
<a name="__getitem__"></a><small>CIHRGrant.</small>**[<ins>__getitem__</ins>]({{ site.baseurl }}{{ page.url }}#__getitem__)**(_key_):
...
<a name="__eq__"></a><small>CIHRGrant.</small>**[<ins>__eq__</ins>]({{ site.baseurl }}{{ page.url }}#__eq__)**(_other_):
...
<a name="__str__"></a><small>CIHRGrant.</small>**[<ins>__str__</ins>]({{ site.baseurl }}{{ page.url }}#__str__)**():
...
<a name="__repr__"></a><small>CIHRGrant.</small>**[<ins>__repr__</ins>]({{ site.baseurl }}{{ page.url }}#__repr__)**():
...
<a name="get"></a><small>CIHRGrant.</small>**[<ins>get</ins>]({{ site.baseurl }}{{ page.url }}#get)**(_key, default=None_):
...
<a name="keys"></a><small>CIHRGrant.</small>**[<ins>keys</ins>]({{ site.baseurl }}{{ page.url }}#keys)**():
...
<a name="items"></a><small>CIHRGrant.</small>**[<ins>items</ins>]({{ site.baseurl }}{{ page.url }}#items)**():
...
<a name="values"></a><small>CIHRGrant.</small>**[<ins>values</ins>]({{ site.baseurl }}{{ page.url }}#values)**():
...
<a name="pop"></a><small>CIHRGrant.</small>**[<ins>pop</ins>]({{ site.baseurl }}{{ page.url }}#pop)**(_key, default=<object object at 0x1048a1050>_):
...
<a name="popitem"></a><small>CIHRGrant.</small>**[<ins>popitem</ins>]({{ site.baseurl }}{{ page.url }}#popitem)**():
...
<a name="clear"></a><small>CIHRGrant.</small>**[<ins>clear</ins>]({{ site.baseurl }}{{ page.url }}#clear)**():
...
<a name="setdefault"></a><small>CIHRGrant.</small>**[<ins>setdefault</ins>]({{ site.baseurl }}{{ page.url }}#setdefault)**(_key, default=None_):
...
<a name="update"></a><small>MedlineGrant.</small>**[<ins>update</ins>]({{ site.baseurl }}{{ page.url }}#update)**(_other_):
...
<a name="copy"></a><small>MedlineGrant.</small>**[<ins>copy</ins>]({{ site.baseurl }}{{ page.url }}#copy)**():

# Needs to be written

<hr style="padding: 0;border: none;border-width: 3px;height: 20px;color: #333;text-align: center;border-top-style: solid;border-bottom-style: solid;">

<a name="__hash__"></a><small>MedlineGrant.</small>**[<ins>__hash__</ins>]({{ site.baseurl }}{{ page.url }}#__hash__)**():
...
<a name="__getitem__"></a><small>MedlineGrant.</small>**[<ins>__getitem__</ins>]({{ site.baseurl }}{{ page.url }}#__getitem__)**(_key_):
...
<a name="__eq__"></a><small>MedlineGrant.</small>**[<ins>__eq__</ins>]({{ site.baseurl }}{{ page.url }}#__eq__)**(_other_):
...
<a name="__str__"></a><small>MedlineGrant.</small>**[<ins>__str__</ins>]({{ site.baseurl }}{{ page.url }}#__str__)**():
...
<a name="__repr__"></a><small>MedlineGrant.</small>**[<ins>__repr__</ins>]({{ site.baseurl }}{{ page.url }}#__repr__)**():
...
<a name="get"></a><small>MedlineGrant.</small>**[<ins>get</ins>]({{ site.baseurl }}{{ page.url }}#get)**(_key, default=None_):
...
<a name="keys"></a><small>MedlineGrant.</small>**[<ins>keys</ins>]({{ site.baseurl }}{{ page.url }}#keys)**():
...
<a name="items"></a><small>MedlineGrant.</small>**[<ins>items</ins>]({{ site.baseurl }}{{ page.url }}#items)**():
...
<a name="values"></a><small>MedlineGrant.</small>**[<ins>values</ins>]({{ site.baseurl }}{{ page.url }}#values)**():
...
<a name="pop"></a><small>MedlineGrant.</small>**[<ins>pop</ins>]({{ site.baseurl }}{{ page.url }}#pop)**(_key, default=<object object at 0x1048a1050>_):
...
<a name="popitem"></a><small>MedlineGrant.</small>**[<ins>popitem</ins>]({{ site.baseurl }}{{ page.url }}#popitem)**():
...
<a name="clear"></a><small>MedlineGrant.</small>**[<ins>clear</ins>]({{ site.baseurl }}{{ page.url }}#clear)**():
...
<a name="setdefault"></a><small>MedlineGrant.</small>**[<ins>setdefault</ins>]({{ site.baseurl }}{{ page.url }}#setdefault)**(_key, default=None_):
...
<a name="copy"></a><small>NSERCGrant.</small>**[<ins>copy</ins>]({{ site.baseurl }}{{ page.url }}#copy)**():

# Needs to be written

<hr style="padding: 0;border: none;border-width: 3px;height: 20px;color: #333;text-align: center;border-top-style: solid;border-bottom-style: solid;">

<a name="__hash__"></a><small>NSERCGrant.</small>**[<ins>__hash__</ins>]({{ site.baseurl }}{{ page.url }}#__hash__)**():
...
<a name="__getitem__"></a><small>NSERCGrant.</small>**[<ins>__getitem__</ins>]({{ site.baseurl }}{{ page.url }}#__getitem__)**(_key_):
...
<a name="__eq__"></a><small>NSERCGrant.</small>**[<ins>__eq__</ins>]({{ site.baseurl }}{{ page.url }}#__eq__)**(_other_):
...
<a name="__str__"></a><small>NSERCGrant.</small>**[<ins>__str__</ins>]({{ site.baseurl }}{{ page.url }}#__str__)**():
...
<a name="__repr__"></a><small>NSERCGrant.</small>**[<ins>__repr__</ins>]({{ site.baseurl }}{{ page.url }}#__repr__)**():
...
<a name="get"></a><small>NSERCGrant.</small>**[<ins>get</ins>]({{ site.baseurl }}{{ page.url }}#get)**(_key, default=None_):
...
<a name="keys"></a><small>NSERCGrant.</small>**[<ins>keys</ins>]({{ site.baseurl }}{{ page.url }}#keys)**():
...
<a name="items"></a><small>NSERCGrant.</small>**[<ins>items</ins>]({{ site.baseurl }}{{ page.url }}#items)**():
...
<a name="values"></a><small>NSERCGrant.</small>**[<ins>values</ins>]({{ site.baseurl }}{{ page.url }}#values)**():
...
<a name="pop"></a><small>NSERCGrant.</small>**[<ins>pop</ins>]({{ site.baseurl }}{{ page.url }}#pop)**(_key, default=<object object at 0x1048a1050>_):
...
<a name="popitem"></a><small>NSERCGrant.</small>**[<ins>popitem</ins>]({{ site.baseurl }}{{ page.url }}#popitem)**():
...
<a name="clear"></a><small>NSERCGrant.</small>**[<ins>clear</ins>]({{ site.baseurl }}{{ page.url }}#clear)**():
...
<a name="setdefault"></a><small>NSERCGrant.</small>**[<ins>setdefault</ins>]({{ site.baseurl }}{{ page.url }}#setdefault)**(_key, default=None_):
...
<a name="copy"></a><small>MedlineRecord.</small>**[<ins>copy</ins>]({{ site.baseurl }}{{ page.url }}#copy)**():

# Needs to be written

<hr style="padding: 0;border: none;border-width: 3px;height: 20px;color: #333;text-align: center;border-top-style: solid;border-bottom-style: solid;">

<a name="get"></a><small>MedlineRecord.</small>**[<ins>get</ins>]({{ site.baseurl }}{{ page.url }}#get)**(_tag, default=None, raw=False_):
...
<a name="values"></a><small>MedlineRecord.</small>**[<ins>values</ins>]({{ site.baseurl }}{{ page.url }}#values)**(_raw=False_):
...
<a name="items"></a><small>MedlineRecord.</small>**[<ins>items</ins>]({{ site.baseurl }}{{ page.url }}#items)**(_raw=False_):
...
<a name="subDict"></a><small>MedlineRecord.</small>**[<ins>subDict</ins>]({{ site.baseurl }}{{ page.url }}#subDict)**(_tags, raw=True_):
...
<a name="createCitation"></a><small>MedlineRecord.</small>**[<ins>createCitation</ins>]({{ site.baseurl }}{{ page.url }}#createCitation)**(_multiCite=False_):
...
<a name="keys"></a><small>MedlineRecord.</small>**[<ins>keys</ins>]({{ site.baseurl }}{{ page.url }}#keys)**():
...
<a name="isdisjoint"></a><small>Collection.</small>**[<ins>isdisjoint</ins>]({{ site.baseurl }}{{ page.url }}#isdisjoint)**(_other_):
...
<a name="copy"></a><small>CollectionWithIDs.</small>**[<ins>copy</ins>]({{ site.baseurl }}{{ page.url }}#copy)**():

# Needs to be written

<hr style="padding: 0;border: none;border-width: 3px;height: 20px;color: #333;text-align: center;border-top-style: solid;border-bottom-style: solid;">

<a name="peak"></a><small>CollectionWithIDs.</small>**[<ins>peak</ins>]({{ site.baseurl }}{{ page.url }}#peak)**():

# Needs to be written

<hr style="padding: 0;border: none;border-width: 3px;height: 20px;color: #333;text-align: center;border-top-style: solid;border-bottom-style: solid;">

<a name="chunk"></a><small>CollectionWithIDs.</small>**[<ins>chunk</ins>]({{ site.baseurl }}{{ page.url }}#chunk)**(_maxSize_):

# Needs to be written

<hr style="padding: 0;border: none;border-width: 3px;height: 20px;color: #333;text-align: center;border-top-style: solid;border-bottom-style: solid;">

<a name="split"></a><small>CollectionWithIDs.</small>**[<ins>split</ins>]({{ site.baseurl }}{{ page.url }}#split)**(_maxSize_):
...
<a name="add"></a><small>CollectionWithIDs.</small>**[<ins>add</ins>]({{ site.baseurl }}{{ page.url }}#add)**(_elem_):
...
<a name="discard"></a><small>CollectionWithIDs.</small>**[<ins>discard</ins>]({{ site.baseurl }}{{ page.url }}#discard)**(_elem_):
...
<a name="remove"></a><small>CollectionWithIDs.</small>**[<ins>remove</ins>]({{ site.baseurl }}{{ page.url }}#remove)**(_elem_):
...
<a name="clear"></a><small>CollectionWithIDs.</small>**[<ins>clear</ins>]({{ site.baseurl }}{{ page.url }}#clear)**():
...
<a name="pop"></a><small>CollectionWithIDs.</small>**[<ins>pop</ins>]({{ site.baseurl }}{{ page.url }}#pop)**():
...
<a name="isdisjoint"></a><small>CollectionWithIDs.</small>**[<ins>isdisjoint</ins>]({{ site.baseurl }}{{ page.url }}#isdisjoint)**(_other_):
...
<a name="copy"></a><small>ExtendedRecord.</small>**[<ins>copy</ins>]({{ site.baseurl }}{{ page.url }}#copy)**():
...
<a name="keys"></a><small>ExtendedRecord.</small>**[<ins>keys</ins>]({{ site.baseurl }}{{ page.url }}#keys)**():
...
<a name="__getitem__"></a><small>Record.</small>**[<ins>__getitem__</ins>]({{ site.baseurl }}{{ page.url }}#__getitem__)**(_key_):
...
<a name="get"></a><small>Record.</small>**[<ins>get</ins>]({{ site.baseurl }}{{ page.url }}#get)**(_key, default=None_):
...
<a name="keys"></a><small>Record.</small>**[<ins>keys</ins>]({{ site.baseurl }}{{ page.url }}#keys)**():
...
<a name="items"></a><small>Record.</small>**[<ins>items</ins>]({{ site.baseurl }}{{ page.url }}#items)**():
...
<a name="values"></a><small>Record.</small>**[<ins>values</ins>]({{ site.baseurl }}{{ page.url }}#values)**():
...
<a name="copy"></a><small>ProQuestRecord.</small>**[<ins>copy</ins>]({{ site.baseurl }}{{ page.url }}#copy)**():

# Needs to be written

<hr style="padding: 0;border: none;border-width: 3px;height: 20px;color: #333;text-align: center;border-top-style: solid;border-bottom-style: solid;">

<a name="get"></a><small>ProQuestRecord.</small>**[<ins>get</ins>]({{ site.baseurl }}{{ page.url }}#get)**(_tag, default=None, raw=False_):
...
<a name="values"></a><small>ProQuestRecord.</small>**[<ins>values</ins>]({{ site.baseurl }}{{ page.url }}#values)**(_raw=False_):
...
<a name="items"></a><small>ProQuestRecord.</small>**[<ins>items</ins>]({{ site.baseurl }}{{ page.url }}#items)**(_raw=False_):
...
<a name="subDict"></a><small>ProQuestRecord.</small>**[<ins>subDict</ins>]({{ site.baseurl }}{{ page.url }}#subDict)**(_tags, raw=True_):
...
<a name="createCitation"></a><small>ProQuestRecord.</small>**[<ins>createCitation</ins>]({{ site.baseurl }}{{ page.url }}#createCitation)**(_multiCite=False_):
...
<a name="keys"></a><small>ProQuestRecord.</small>**[<ins>keys</ins>]({{ site.baseurl }}{{ page.url }}#keys)**():
...
<a name="copy"></a><small>RecordCollection.</small>**[<ins>copy</ins>]({{ site.baseurl }}{{ page.url }}#copy)**():
...
<a name="chunk"></a><small>RecordCollection.</small>**[<ins>chunk</ins>]({{ site.baseurl }}{{ page.url }}#chunk)**(_maxSize_):

# Needs to be written

<hr style="padding: 0;border: none;border-width: 3px;height: 20px;color: #333;text-align: center;border-top-style: solid;border-bottom-style: solid;">

<a name="split"></a><small>RecordCollection.</small>**[<ins>split</ins>]({{ site.baseurl }}{{ page.url }}#split)**(_maxSize_):
...
<a name="containsID"></a><small>RecordCollection.</small>**[<ins>containsID</ins>]({{ site.baseurl }}{{ page.url }}#containsID)**(_idVal_):

# Needs to be written

<hr style="padding: 0;border: none;border-width: 3px;height: 20px;color: #333;text-align: center;border-top-style: solid;border-bottom-style: solid;">

<a name="discardID"></a><small>RecordCollection.</small>**[<ins>discardID</ins>]({{ site.baseurl }}{{ page.url }}#discardID)**(_idVal_):

# Needs to be written

<hr style="padding: 0;border: none;border-width: 3px;height: 20px;color: #333;text-align: center;border-top-style: solid;border-bottom-style: solid;">

<a name="removeID"></a><small>RecordCollection.</small>**[<ins>removeID</ins>]({{ site.baseurl }}{{ page.url }}#removeID)**(_idVal_):

# Needs to be written

<hr style="padding: 0;border: none;border-width: 3px;height: 20px;color: #333;text-align: center;border-top-style: solid;border-bottom-style: solid;">

<a name="getID"></a><small>RecordCollection.</small>**[<ins>getID</ins>]({{ site.baseurl }}{{ page.url }}#getID)**(_idVal_):

# Needs to be written

<hr style="padding: 0;border: none;border-width: 3px;height: 20px;color: #333;text-align: center;border-top-style: solid;border-bottom-style: solid;">

<a name="badEntries"></a><small>RecordCollection.</small>**[<ins>badEntries</ins>]({{ site.baseurl }}{{ page.url }}#badEntries)**():

# Needs to be written

<hr style="padding: 0;border: none;border-width: 3px;height: 20px;color: #333;text-align: center;border-top-style: solid;border-bottom-style: solid;">

<a name="dropBadEntries"></a><small>RecordCollection.</small>**[<ins>dropBadEntries</ins>]({{ site.baseurl }}{{ page.url }}#dropBadEntries)**():

# Needs to be written

<hr style="padding: 0;border: none;border-width: 3px;height: 20px;color: #333;text-align: center;border-top-style: solid;border-bottom-style: solid;">

<a name="tags"></a><small>RecordCollection.</small>**[<ins>tags</ins>]({{ site.baseurl }}{{ page.url }}#tags)**():

# Needs to be written

<hr style="padding: 0;border: none;border-width: 3px;height: 20px;color: #333;text-align: center;border-top-style: solid;border-bottom-style: solid;">

<a name="oneModeNetwork"></a><small>RecordCollection.</small>**[<ins>oneModeNetwork</ins>]({{ site.baseurl }}{{ page.url }}#oneModeNetwork)**(_mode, nodeCount=True, edgeWeight=True, stemmer=None, edgeAttribute=None, nodeAttribute=None_):
...
<a name="twoModeNetwork"></a><small>RecordCollection.</small>**[<ins>twoModeNetwork</ins>]({{ site.baseurl }}{{ page.url }}#twoModeNetwork)**(_tag1, tag2, directed=False, recordType=True, nodeCount=True, edgeWeight=True, stemmerTag1=None, stemmerTag2=None, edgeAttribute=None_):
...
<a name="nModeNetwork"></a><small>RecordCollection.</small>**[<ins>nModeNetwork</ins>]({{ site.baseurl }}{{ page.url }}#nModeNetwork)**(_tags, recordType=True, nodeCount=True, edgeWeight=True, stemmer=None, edgeAttribute=None_):
...
<a name="add"></a><small>RecordCollection.</small>**[<ins>add</ins>]({{ site.baseurl }}{{ page.url }}#add)**(_elem_):
...
<a name="discard"></a><small>RecordCollection.</small>**[<ins>discard</ins>]({{ site.baseurl }}{{ page.url }}#discard)**(_elem_):
...
<a name="remove"></a><small>RecordCollection.</small>**[<ins>remove</ins>]({{ site.baseurl }}{{ page.url }}#remove)**(_elem_):
...
<a name="clear"></a><small>RecordCollection.</small>**[<ins>clear</ins>]({{ site.baseurl }}{{ page.url }}#clear)**():
...
<a name="isdisjoint"></a><small>RecordCollection.</small>**[<ins>isdisjoint</ins>]({{ site.baseurl }}{{ page.url }}#isdisjoint)**(_other_):
...
<a name="proQuestRecordParser"></a><small>proquest.</small>**[<ins>proQuestRecordParser</ins>]({{ site.baseurl }}{{ page.url }}#proQuestRecordParser)**(_record, recNum_):
